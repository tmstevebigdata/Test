...
> 4) How to run the R scripts

### 1) Purpose

```
The purpose of this project is to here is simply to examine how household energy usage varies over a 2-day
period in February, 2007. The task is to reconstruct the following plots below, all of which were
...
Data Set” which has been made available on the course web site.
...
of your repository is up to date. There should be four PNG files and four R code files, a total of eight
...
```html
<span style="color:red; font-family:Georgia; font-size:2em;">Plot 1</span><br>
<img src=https://d396qusza40orc.cloudfront.net/exdata/CP1/ExDataCP1Plot1.png><br>
```
...
The GitHub repo consist of 9 files as detailed below:-

```
1) README.md - This file explains the purpose of the project and the steps on how to run the R scripts.

2) plot1.R, plot2.R, plot3.R, plot4.R - The R source files used to product the output plots in PNG format.

3) plot1.png, plot2.png, plot3.png, plot4.png - The plot output files in PNG format.
```
...
```
Step 1 - Download the R scripts to a local directory

Step 2 - Download the data from the link given above in Item 3 - Data Source
